    ...
    <div className="h-screen">
      ...
      <div className="navbar">
        <div className="flex-1">
          <span className="text-primary uppercase text-2xl font-bold">
            Walletify
          </span>
        </div>
          ...
          {isConnected && childContract === null && (
            <div className="form-control">
              <button
                ...
                } btn btn-md w-24 md:w-auto text-white bg-primary `}
              >
                {creatingWallet && (
      ...
      {childContract == null && (
        <span className="w-full block text-center mt-3 text-lg font-bold text-primary">
          Connect your wallet to seamlessly create a smart wallet.
        </span>
      )}
